...
```bash
git clone https://github.com/yourusername/xtest.git
cd xtest
```
...
详细的 API 文档请查看 [API_DOCUMENTATION.md](docs/API_DOCUMENTATION.md)
...
| | `/api/testplans/create` | POST | 创建计划 |
| 用例 | `/api/testcases/list` | GET | 用例列表 |
| | `/api/testcases/create` | POST | 创建用例 |
